...
OVA_TAG = tag_key("ova")
OVA_SOURCE_TAG = tag_key("ova-source")
OVA_ETAG_TAG = tag_key("ova-etag")
TAG_SOURCE_OVA = tag_key("source-ova")
OVA_DISPLAY_PREFIX = f"{PREFIX}-ova"
...
TAG_SOURCE_HYPERV = tag_key("source-hyperv")
