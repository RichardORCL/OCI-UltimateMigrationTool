...
The start page lists every option (VMware, Hyper-V, OLVM, Azure, AWS, Google Cloud, OVA import, ISO, Remote Console,
...
# Hyper-V (WinRM HTTPS, and SMB for the disk files)
curl -k -sI https://<hyperv-host>:5986/wsman | head -1
# Azure
